...
An Event Listener will take two arguments, first the event to listen for, and then the callback to fire when that event is triggered.
...
A component is made of several parts. HTML, CSS and Javascript are brought together for reuse in a website or an applicaiton.
